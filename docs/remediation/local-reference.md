...
These choices define the reference implementation, not a production SLA. The owner has selected the local setup; measured performance thresholds, release rollout/version, and final supported-runtime acceptance remain open. There is no inferred staffing, commercial or delivery-date commitment.
