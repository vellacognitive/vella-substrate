...
**In development — SDK 2.1.0 / MCP 1.1.0 (unpublished):** the owner-approved [v3 hybrid proof contract](spec/pqc/PROOF-CONTRACT.md) adds opt-in P-256 + ML-DSA-65 proofs and SHA-384 bindings. [Migration](spec/pqc/MIGRATION.md) · [Qualification status](spec/pqc/ACCEPTANCE.md). This is a proof-boundary feature, not a claim that the whole platform is quantum safe.
