// Private review CLI. Explicit historical verification, never an execution token.
...
try {
  ...
  if (trust.kind !== 'vella_local_hybrid_keys_draft1' || !Number.isSafeInteger(trust.revision) || trust.revision < 0 || !Array.isArray(trust.history) || trust.history.length > 256 || !Object.hasOwn(trust, 'activeId') || Object.keys(trust).length !== 4) throw new Error('invalid public trust registry');
